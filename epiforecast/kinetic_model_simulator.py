...
class KineticModel:
    def __init__(self,
        ...
        self.diagram_neigh.add_edge(('I', 'S'), ('I', 'E'), rate = self.community_transmission_rate, weight_label = 'contact_with_infected')
        self.diagram_neigh.add_edge(('H', 'S'), ('H', 'E'), rate = self.hospital_transmission_rate,  weight_label = 'contact_with_hospitalized')
    ...
    def set_mean_contact_duration(self, mean_contact_duration):
        ...
        nx.set_edge_attributes(self.contact_network, values=weights, name='contact_with_infected')
        nx.set_edge_attributes(self.contact_network, values=weights, name='contact_with_hospitalized')
