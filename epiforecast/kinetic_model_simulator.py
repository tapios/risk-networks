...
class KineticModel:
    """
    Implements a Kinetic Monte-Carlo simulation of an epidemic on a contact network.
    """
    def __init__(self,
                 edges,
                 node_identifiers,
       ...
       mean_contact_duration (np.array): The mean contact duration of each node in the contact network over which we simulate
    ...
    def vacate_hospital_bed(self):
        ...
        for hospital_bed in self.node_identifiers["hospital_beds"]:
            ...
            if self.node_statuses[hospital_bed] != 'P' and self.node_statuses[hospital_bed] != 'H':
                ...
                print("Sending home patient", hospital_bed, 
                                        "to", self.address_of_patient[hospital_bed], 
                                  "in state", self.node_statuses[hospital_bed])
