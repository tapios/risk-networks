...
ax00.bar(NYC_data_date_of_interest_deaths, cumulative_deaths_NYC, facecolor='red', edgecolor='red', alpha = 0.4, width = 0.0001)
...
ax00.set_ylim(0,800)
ax00.set_xlim([dt.date(2020, 2, 23), dt.date(2020, 7, 12)])
...
ax01.set_xlim([dt.date(2020, 2, 23), dt.date(2020, 7, 12)])
...
ax10.fill_between(NYC_data_date_of_interest_deaths[::7]+dt.timedelta(days = 3.5), NYC_death_data_weekly, edgecolor = 'red', facecolor = 'red', alpha = 0.15, linewidth = 1.)
ax10.plot(NYC_data_date_of_interest_deaths[::7]+dt.timedelta(days = 3.5), NYC_death_data_weekly,  color = 'red',  linewidth = 1.)

ax10.bar(NYC_data_date_of_interest_deaths, reported_deaths_NYC, facecolor='red', edgecolor='red', alpha = 0.4, width = 0.0001)
...
ax10.set_xlim([dt.date(2020, 2, 23), dt.date(2020, 7, 12)])
...
ax11.set_xlim([dt.date(2020, 2, 23), dt.date(2020, 7, 12)])
...
for i in range(20):
    ...
    ax00.plot(simulation_dates_nointervention+dt.timedelta(days = dd), cumulative_deaths_simulation_nointervention, 'Grey', linewidth = 0.8, alpha = 0.2)
    
    ax01.plot(simulation_dates+dt.timedelta(days = dd), cumulative_cases_simulation, 'cornflowerblue', linewidth = 0.8, alpha = 0.2)
    ax01.plot(simulation_dates_nointervention+dt.timedelta(days = dd), cumulative_cases_simulation_nointervention, 'Grey', linewidth = 0.8, alpha = 0.2)
    
    ax10.plot(simulation_dates2+dt.timedelta(days = dd), deaths_simulation, 'cornflowerblue', linewidth = 0.8, alpha = 0.2)
    ax10.plot(simulation_dates_nointervention2+dt.timedelta(days = dd), deaths_simulation_nointervention, 'Grey', linewidth = 0.8, alpha = 0.2)
    
    ax11.plot(simulation_dates2+dt.timedelta(days = dd), cases_simulation, 'cornflowerblue', linewidth = 0.8, alpha = 0.2)
    ax11.plot(simulation_dates_nointervention2+dt.timedelta(days = dd), cases_simulation_nointervention, 'Grey', linewidth = 0.8, alpha = 0.2)
...
ax00.plot(simulation_dates+dt.timedelta(days = dd), np.mean(cumulative_deaths_simulation_mean_arr, axis = 0), 'cornflowerblue', linewidth = 1.5)
ax00.plot(simulation_dates_nointervention+dt.timedelta(days = dd), np.mean(cumulative_deaths_simulation_nointervention_mean_arr, axis = 0), 'Grey', linewidth = 1.5)

ax01.plot(simulation_dates+dt.timedelta(days = dd), np.mean(cumulative_cases_simulation_mean_arr, axis = 0), 'cornflowerblue', linewidth = 1.5)
ax01.plot(simulation_dates_nointervention+dt.timedelta(days = dd), np.mean(cumulative_cases_simulation_nointervention_mean_arr, axis = 0), 'Grey', linewidth = 1.5)

ax10.plot(simulation_dates2+dt.timedelta(days = dd), np.mean(deaths_simulation_mean_arr, axis = 0), 'cornflowerblue', linewidth = 1.5)
ax10.plot(simulation_dates_nointervention2+dt.timedelta(days = dd), np.mean(deaths_simulation_nointervention_mean_arr, axis = 0), 'Grey', linewidth = 1.5)

ax11.plot(simulation_dates2+dt.timedelta(days = dd), np.mean(cases_simulation_mean_arr, axis = 0), 'cornflowerblue', linewidth = 1.5)
ax11.plot(simulation_dates_nointervention2+dt.timedelta(days = dd), np.mean(cases_simulation_nointervention_mean_arr, axis = 0), 'Grey', linewidth = 1.5)
...
for i in range(20):
    ...
    ax00.plot(simulation_dates_nointervention+dt.timedelta(days = dd), hospitalizations_simulation_nointervention, 'Grey', linewidth = 0.8, alpha = 0.2)
    ...
    ax01.plot(simulation_dates_nointervention[:-1]+dt.timedelta(days = dd), hospitalizations_simulation_nointervention_daily, 'Grey', linewidth = 0.8, alpha = 0.2)
...
ax00.plot(simulation_dates_nointervention+dt.timedelta(days = dd), np.mean(hospitalizations_simulation_nointervention_mean_arr, axis = 0), 'Grey')
...
ax01.plot(simulation_dates_nointervention[:-1]+dt.timedelta(days = dd), np.mean(hospitalizations_simulation_nointervention_daily_mean_arr, axis = 0), 'Grey')
