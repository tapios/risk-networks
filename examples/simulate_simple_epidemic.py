...
for i in range(steps):
    ...
    print("kinetic model time: ", kinetic_model.times[-1], 
          "total number of nodes in state S:", kinetic_model.statuses['S'][-1], 
          "E:", kinetic_model.statuses['E'][-1], 
          "I:", kinetic_model.statuses['I'][-1], 
          "H:", kinetic_model.statuses['H'][-1], 
          "R:", kinetic_model.statuses['R'][-1], 
          "D:", kinetic_model.statuses['D'][-1], "\n")
...
plt.savefig("test_epidemic_SD.png", dpi = 300)
