...
sensor_assimilator = DataAssimilator(
        ...
        additive_inflate=arguments.additive_inflation,
        additive_inflate_factor=arguments.additive_inflation_factor,
...
record_assimilation_interval = 1000.0*noda_delay # assimilate H and D data every .. days
