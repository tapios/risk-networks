...
EXP_NAME="u25rand_s0_d1_i0.001" #1e5 = 97942 nodes
#EXP_NAME="noda_1e5_parsd0.25_nosd"
# Experimental series parameters ###############################################
#5% 10% 25%, of 97942
test_budgets=(0 245 612 1224 2448 6121 24515)  
...
cp batch_scripts/run_u25rand_s0_d1_i0.001.sh ${output_path}
