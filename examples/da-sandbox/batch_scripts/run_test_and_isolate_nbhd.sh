...
#SBATCH --mem=192G
#SBATCH -J "test_and_isolate_nbhd"
...
intervention_nodes='test_data_neighbors'
...
EXP_NAME="test_and_isolate_nbhd" #1e5 = 97942 nodes
...
cp batch_scripts/run_test_and_isolate_nbhd.sh ${output_path}
