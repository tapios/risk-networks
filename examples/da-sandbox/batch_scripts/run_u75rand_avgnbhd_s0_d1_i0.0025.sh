...
EXP_NAME="u75rand_avgnbhd_s0_d1_i0.0025" #1e5 = 97942 nodes
#EXP_NAME="noda_1e5_parsd0.25_nosd"
# Experimental series parameters ###############################################
#5% 10% 25%, of 97942
test_budgets=(0 734 1836 3672 7347 18364 73353)  
...
cp batch_scripts/run_u75rand_avgnbhd_s0_d1_i0.0025.sh ${output_path}
...
python3 joint_iterated_forward_assimilation.py \
  ...
  --user-network-external-neighbor-type=${exterior_nbhd_type}\
