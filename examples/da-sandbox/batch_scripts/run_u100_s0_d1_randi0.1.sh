...
random_intervention_budget=9794 #10%
#da params 
da_window=1.0
n_sweeps=1
...
EXP_NAME="u100_s0_d1_randi0.1" #1e5 = 97942 nodes
...
cp batch_scripts/run_u100_s0_d1_randi0.1.sh ${output_path}
