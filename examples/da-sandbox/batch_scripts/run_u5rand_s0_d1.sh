...
#EXP_NAME="noda_1e5_u5_parsd0.25_nosd" 
EXP_NAME="noda_u5rand_exog${user_base_weight}" #1e5 = 97942 nodes

# Experimental series parameters ###############################################
#5% 10% 25%, of user base 24485
test_budgets=(0 245 489 1224 4897)  
...
cp batch_scripts/run_u5rand_s0_d1.sh ${output_path}
