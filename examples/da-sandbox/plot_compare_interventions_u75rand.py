...
#Plotting script to compare model-based and non model based interventions for the 75% random-based user network
...
INTERVENTION_CASE_NAMES = [
    "u75rand_s0_d1_i0.0075_3672",
    "u75rand_s0_d1_i0.0075_18364",
