...
for i in range(1,total_steps):
    ...
    master_eqn_ensemble.contact_network = contact_network_list[total_steps-1-i]
    ...
    # perform data assimlation [update the master eqn states, the transition rates, and the transmission rate (if supplied)]
        (states_ensemble,
         ...
         community_transmission_rate_ensemble
                                ...
                                data = epidemic_simulator_states_list[total_steps-1-i],
                                ...
                                user_network = contact_network_list[total_steps-1-i])
    ...
    axes = plot_ensemble_states(master_eqn_ensemble.states_trace,
                                np.linspace(stop_time, start_time, 25 + 1),
                                axes = axes,
    ...
    plt.savefig('backward_da_ric_tprobs_'+plot_name_observations+'.png', rasterized=True, dpi=150)
