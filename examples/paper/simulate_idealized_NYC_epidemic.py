...
network = epidemic_simulator.run(
    stop_time = epidemic_simulator.time + 40,
    current_network = network)
...
if SAVE_FLAG:
    np.savetxt(
            ...
            header = 'S E I H R D seed1: %d seed2: %d seed3: %d seed4: %d seed 5: %d seed 6: %d'%(SEED1,SEED2,SEED3,SEED4,SEED5,SEED6))
